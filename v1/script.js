...
async function loadFacts() {
    const res = await fetch(
        "https://yoidkpwbeexzgcjdigsv.supabase.co/rest/v1/facts",
        {
            headers: {
                apikey:
                ...
                authorization:
                    "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlvaWRrcHdiZWV4emdjamRpZ3N2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODkxNzEyNzIsImV4cCI6MjAwNDc0NzI3Mn0.I8s9FWbqC09v8FIPKpZooR8VlI9iPNioLSeYNurGHIw",
            },
        }
    );
